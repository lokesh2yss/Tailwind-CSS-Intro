...
const Hero = () => {
  return (
      <div className="mx-6 my-5 text-center md:mx-12 lg:w-6xl lg-pt-20 lg:mx-auto">
          <div id="testimonial-container" className="flex gap-6 flex-wrap justify-evenly">
              ...
              <HeaderTestimonial text="Way easier than Calendly." starsCount={3}/>
          ...
          <button className="mt-8 cursor-pointer font-medium
                 text-xl lg:text-3xl text-black px-8 py-4 lg:px-10 rounded-xl
                bg-yellow-400 font-body hover:bg-yellow-300
                 hover:-translate-y-1 transition-all">Try SavvyCal risk-free</button>
